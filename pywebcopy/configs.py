...
class ConfigHandler(UserDict):
    ...
    def setup_config(self, project_url=None, project_folder=None, project_name=None,
                     ...
                     load_images=True, join_timeout=None, base_url=None, log_file=None, debug=False):
        ...
        self.update(
            ...
            load_images=load_images, join_timeout=join_timeout, base_url=base_url, debug=debug, log_file=log_file
        )
